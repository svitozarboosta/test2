...
( function( $ ) {
	var $style = $( '#cleanblog-color-scheme-css' ),
		api = wp.customize;

	if ( ! $style.length ) {
		$style = $( 'head' ).append( '<style type="text/css" id="cleanblog-color-scheme-css" />' )
		                    .find( '#cleanblog-color-scheme-css' );
	}
	...
	wp.customize( 'footer_widget_text_colors', function( value ) {
		...
		wp.customize( 'post_tags_categories_text', function( value ) {
		value.bind( function( to ) {
			$( '.tags-section a, .tags-section a:visited, .tags-section a:hover, .tags-section a:active, .tags-section a:focus, .post-categories li a, .post-categories li a:visited, .post-categories li a:hover, .post-categories li a:focus, .post-categories li a:active' ).css( {
				'color':to
			});
		} );
	} );
		wp.customize( 'post_tags_categories_bg', function( value ) {
		value.bind( function( to ) {
			$( '.tags-section a, .tags-section a:visited, .tags-section a:hover, .tags-section a:active, .tags-section a:focus, .post-categories li a, .post-categories li a:visited, .post-categories li a:hover, .post-categories li a:focus, .post-categories li a:active' ).css( {
				'background':to
			});
		...
		wp.customize( 'header_btn_one_text_color', function( value ) {
		value.bind( function( to ) {
			$( '.header_btn_one_text, .header_btn_one_text:hover, .header_btn_one_text:active, .header_btn_one_text:focus' ).css( {
				'color':to
			});
		} );
	} );
		wp.customize( 'header_btn_one_background_color', function( value ) {
		value.bind( function( to ) {
			$( '.header_btn_one_text, .header_btn_one_text:hover, .header_btn_one_text:active, .header_btn_one_text:focus' ).css( {
				'border-color':to
			});
		...
		wp.customize( 'header_btn_two_background_color', function( value ) {
		value.bind( function( to ) {
			$( '.header_btn_two_text, .header_btn_two_text:hover, .header_btn_two_text:active, .header_btn_two_text:focus' ).css( {
				'background':to
			});
		} );
	} );		
		...
		wp.customize( 'header_btn_two_text_color', function( value ) {
		value.bind( function( to ) {
			$( '.header_btn_two_text, .header_btn_two_text:hover, .header_btn_two_text:active, .header_btn_two_text:focus' ).css( {
				'color':to
			});
		...
		value.bind( function( to ) {
			...
			wp.customize( 'post_feed_post_button_bg', function( value ) {
		value.bind( function( to ) {
			$( '.blog .btn' ).css( {
				'background':to
			});
			...
			wp.customize( 'post_feed_post_button_readmore_text', function( value ) {
		value.bind( function( to ) {
			$( '.blog .btn' ).css( {
				'color':to
			});
